...
int main()
{
    ...
    std::cout << greeting.append(" this was appended") << std::endl;    // Appends to the end
    std::cout << greeting.insert(3, "      ") << std::endl; // At index 3, we want this string to be there
    std::cout << greeting.erase(3, 2) << std::endl; // Erase 2 characters starting at position 2
